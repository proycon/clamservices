...
import clamservices.config.foliastats #** import your configuration module here! **
import clam.clamservice
application = clam.clamservice.run_wsgi(clamservices.config.foliastats) #** pass your module to CLAM **
