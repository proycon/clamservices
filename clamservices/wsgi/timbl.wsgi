...
import clamservices.config.timbl #** import your configuration module here! **
import clam.clamservice
application = clam.clamservice.run_wsgi(clamservices.config.timbl) #** pass your module to CLAM **
